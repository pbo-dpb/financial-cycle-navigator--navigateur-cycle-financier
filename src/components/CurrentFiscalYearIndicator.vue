...
<script setup>
    ...
    const waterfallArrowHtml = computed(() => {
        ...
        textElement.textContent =
            strings.value.current_fiscal_year + " " + fiscalYear.value;
        containerSvg.appendChild(textElement);

        const approxTextWidth =
            strings.value.current_fiscal_year.length > 20 ? 280 : 220;
        ...
        leftLine.setAttribute(
            "x2",
            waterfallWidth.value / 2 - approxTextWidth / 2,
        );
