...
<template>
    <div class="flex-col items-center gap-2 p-4 lg:flex">
        <div
            ...
            <ul
                v-if="
                    event.part_of_estimates_process || event.previous_spending
                "
                ...
                <li
                    ...
                    <CalculatorIcon
                        class="size-4"
                        aria-hidden="true"></CalculatorIcon>
                ...
                <li
                    ...
                    <ArrowUturnLeftIcon
                        class="size-4"
                        aria-hidden="true"></ArrowUturnLeftIcon>
                    <span class="font-semibold">{{
